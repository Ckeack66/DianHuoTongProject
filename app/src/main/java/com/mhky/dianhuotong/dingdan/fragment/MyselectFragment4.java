 ...
 * Use the {@link MyselectFragment4#newInstance} factory method to
 * create an instance of this fragment.
 * 已完成采购单   Fragment
 */
public class MyselectFragment4 extends Fragment implements OrderIF{
    @BindView(R.id.myselected_fragment4_rv)
     ...
     * @return A new instance of fragment MyselectFragment4.
     */
    // TODO: Rename and change types and number of parameters
    public static MyselectFragment4 newInstance(String param1, String param2, OrderBaseInfo orderBaseInfoInit) {
        MyselectFragment4 fragment = new MyselectFragment4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_myselect_fragment4, container, false);
    ...
    public void getOrderSucess(int code, String result) {
        ...
        if (orderBaseInfo_temp.getNumberOfElements() == 0){
            ...
            srlOrderForm.finishLoadMore(true);
            orderAdapter.addData(orderDataPresenter.getOrderListFragment4(orderBaseInfo_temp));
            srlOrderForm.setEnableLoadMore(false);
            ToastUtil.makeText(getContext(), "已加载全部数据", Toast.LENGTH_SHORT).show();
        }else {
