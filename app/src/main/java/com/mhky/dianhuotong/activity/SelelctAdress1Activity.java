...
public class SelelctAdress1Activity extends BaseActivity implements AdressIF {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selelct_adress1);
    ...
    private void inIt() {
        ...
        areaID = getIntent().getExtras().getString("cityID");
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                BaseTool.goActivityWithData(context, SelelctAdress2Activity.class, bundle);
                return false;
            }
        });
    }
