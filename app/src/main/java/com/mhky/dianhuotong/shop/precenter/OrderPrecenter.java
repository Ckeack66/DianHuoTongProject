...
public class OrderPrecenter {
    private OrderIF orderIF;

    public OrderPrecenter(OrderIF orderIF) {
    ...
    public void getOrder(String id) {
        OkGo.<String>get(BaseUrlTool.GET_ORDERINFO+id+"&size=100000").execute(new Callback<String>() {
            ...
            public void onSuccess(Response<String> response) {
                orderIF.getOrderSucess(response.code(),BaseTool.getResponsBody(response));
            }
            ...
            public void onError(Response<String> response) {
                orderIF.getOrderFaild(response.code(),BaseTool.getResponsBody(response));
            }
