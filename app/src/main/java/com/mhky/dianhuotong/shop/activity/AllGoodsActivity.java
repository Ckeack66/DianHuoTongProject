...
public class AllGoodsActivity extends BaseActivity implements AdapterView.OnItemClickListener, AllGoodsIF {
    ...
    public void getAllGoodsInfoSuccess(int code, String result) {
        if (code == 200) {
            allGoodsBaseInfos = JSON.parseArray(result, AllGoodsBaseInfo.class);
