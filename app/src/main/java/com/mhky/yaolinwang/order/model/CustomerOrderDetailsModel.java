 ...
 * Describe：获取C 端订单详情的Model
 */
public class CustomerOrderDetailsModel extends BaseModle {
    @Override
    public void execute(final BaseCallBack callback) {
        try{
            OkGo.<String>get(BaseUrlTool.GET_CUSTOMER_ORDER_DETAILS).params(httpParams)
