...
import com.mhky.yaolinwang.order.activity.CustomerOrderDetailsActivity;
 ...
 * 全部
 */
public class CustomerOrdersFragment1 extends BaseFragment implements CustomerOrdersView {
    ...
    public CustomerOrdersFragment1() {
     ...
     * @return A new instance of fragment CustomerOrdersFragment1.
     */
    // TODO: Rename and change types and number of parameters
    public static CustomerOrdersFragment1 newInstance(String param1, String param2) {
        CustomerOrdersFragment1 fragment = new CustomerOrdersFragment1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_customer_orders_fragment1, container, false);
                    ...
                    case R.id.btn_1:
                        switch (((TextView)view).getText().toString()){
                            case "去付款":
                                ...
                                BaseTool.goActivityNoData(getContext(), CustomerOrderDetailsActivity.class);
                                break;
                            case "申请退款":
                                BaseTool.logPrint("btn_1",((TextView)view).getText().toString());
                                break;
